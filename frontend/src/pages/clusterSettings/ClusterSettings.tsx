...
const ClusterSettings: React.FC = () => {
    ...
    fetchClusterSettings()
      .then((clusterSettings: ClusterSettings) => {
        ...
        if (clusterSettings.cullerTimeout !== DEFAULT_CULLER_TIMEOUT) {
          ...
          setHour(Math.floor(getHourAndMinuteByTimeout(clusterSettings.cullerTimeout).hour));
  ...
  const radioCheckedChange = (_, event) => {
    ...
    if (value === CULLER_TIMEOUT_UNLIMITED) {
      ...
      submitClusterSettings({
        pvcSize,
        cullerTimeout: getTimeoutByHourAndMinute(hour, minute),
        userTrackingEnabled,
      });
    }
  };
            ...
            >
              ...
              <InputGroup className="odh-cluster-settings__culler-input-group">
                <TextInput
                  ...
                  onBlur={() =>
                    submitClusterSettings({ pvcSize, cullerTimeout, userTrackingEnabled })
                  }
